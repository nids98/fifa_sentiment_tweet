...
f = open('goofyaus.txt','a')
f1 = open('maxidgoofy.txt','r+')

q="q=%23AUS%20😋%20OR%20😛%20OR%20😜%20OR%20😝%20OR%20🤪%20OR%20🤡&src=typd&lang=en&result_type=recent&since=2018-01-01&count=100"

i=0

try:
	tid = f1.read()
	res = api.GetSearch(raw_query=q+"&since_id="+str(eval(tid)+1), return_json=True)
	temp=res["statuses"]
	f1.close()
