...
f = open('celebratingden.txt','a')
f1 = open('maxidcelebrate.txt','r+')

q="q=%23DEN%20🙌%20OR%20✊%20OR%20🕺%20OR%20💃&src=typd&lang=da&result_type=recent&since=2018-01-01&count=100"
